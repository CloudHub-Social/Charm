 ...
 * a key fails `tsc`.
 */
export type FeatureFlagKey = "canary" | "room_invites" | "rich_message_rendering" | "mobile_chat_redesign" | "focus_mode" | "link_previews" | "room_alias_management" | "message_action_parity";
