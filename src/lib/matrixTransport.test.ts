...
describe("matrix web transport", () => {
  ...
  it.each([
    ...
    [
      ...
      "POST",
      "/api/auth/registration/begin",
      { homeserver_url: "https://matrix.example", username: "alice", password: "pw" },
    ],
    [
      "request_registration_email",
      { attemptId: "registration-1", email: "alice@example.org" },
      "POST",
      "/api/auth/registration/email",
      { attempt_id: "registration-1", email: "alice@example.org" },
    ],
    [
      "continue_registration",
      { attemptId: "registration-1", response: { kind: "accept_terms" } },
      "POST",
      "/api/auth/registration/continue",
      { attempt_id: "registration-1", response: { kind: "accept_terms" } },
    ],
    [
      "cancel_registration",
      { attemptId: "registration-1" },
      "POST",
      "/api/auth/registration/cancel",
      { attempt_id: "registration-1" },
    ],
    [
      "request_password_reset",
      { homeserverUrl: "https://matrix.example", email: "alice@example.org" },
      "POST",
      "/api/auth/password-reset/request",
      { homeserver_url: "https://matrix.example", email: "alice@example.org" },
    ],
    [
      "confirm_password_reset",
      { attemptId: "reset-1", token: "123456", newPassword: "new password" },
      "POST",
      "/api/auth/password-reset/confirm",
      { attempt_id: "reset-1", token: "123456", new_password: "new password" },
    ],
    [
    ...
    [
      ...
      "POST",
      "/api/auth/login-flows",
      { homeserver_url: "https://matrix.example" },
    ],
    [
      "login_with_token",
      { homeserverUrl: "https://matrix.example", token: "one-time-token" },
      "POST",
      "/api/auth/token",
      { homeserver_url: "https://matrix.example", token: "one-time-token" },
    ],
    ...
    [
      "list_manageable_space_children",
      { spaceId: "!space:example.org" },
      "GET",
      "/api/rooms/!space%3Aexample.org/space-children/manageable",
      undefined,
    ],
    [
      "join_room",
    ...
    [
      "report_event",
      { roomId: "!r:example.org", eventId: "$e", reason: "spam" },
      "POST",
      "/api/rooms/!r%3Aexample.org/events/%24e/report",
      { reason: "spam", score: null },
    ],
    [
      "get_event_source",
      { roomId: "!r:example.org", eventId: "$e" },
      "GET",
      "/api/rooms/!r%3Aexample.org/events/%24e/source",
      undefined,
    ],
    [
      "get_edit_history",
      { roomId: "!r:example.org", eventId: "$e" },
      "GET",
      "/api/rooms/!r%3Aexample.org/events/%24e/edit-history",
      undefined,
    ],
    [
      ...
      { roomId: "!r:example.org", targetEventId: "$e", key: "👍" },
      "GET",
      "/api/rooms/!r%3Aexample.org/events/%24e/reactions/%F0%9F%91%8D",
      undefined,
    ],
    [
      "forward_message",
      { sourceRoomId: "!r:example.org", eventId: "$e", targetRoomId: "!target:example.org" },
      "POST",
      "/api/rooms/!r%3Aexample.org/events/%24e/forward/!target%3Aexample.org",
      undefined,
    ],
    [
      "run_command",
    ...
    [
      "get_room_local_aliases",
      { roomId: "!r:example.org" },
      "GET",
      "/api/rooms/!r%3Aexample.org/aliases",
      undefined,
    ],
    [
      "check_room_alias_available",
      { alias: "#room:example.org" },
      "POST",
    ...
    [
      "add_room_alias",
      { roomId: "!r:example.org", alias: "#room:example.org" },
      "PUT",
      "/api/rooms/!r%3Aexample.org/aliases",
      "#room:example.org",
    ],
    [
      ...
      { alias: "#room:example.org" },
      "DELETE",
      "/api/rooms/aliases/%23room%3Aexample.org",
      undefined,
    ],
    [
      "set_canonical_alias",
      { roomId: "!r:example.org", alias: "#room:example.org" },
      "PUT",
      "/api/rooms/!r%3Aexample.org/canonical-alias",
      "#room:example.org",
    ],
    [
      "set_canonical_alias",
      { roomId: "!r:example.org", alias: null },
      "PUT",
      "/api/rooms/!r%3Aexample.org/canonical-alias",
      null,
    ],
    [
      "remove_alt_alias",
      { roomId: "!r:example.org", alias: "#alt:example.org" },
      "DELETE",
      "/api/rooms/!r%3Aexample.org/alt-aliases/%23alt%3Aexample.org",
      undefined,
    ],
    [
      "set_room_join_rule",
