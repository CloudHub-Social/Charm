  ...
  return (
    <span
      ...
      className={cn(
        ...
        "absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-primary-solid text-primary-foreground ring-2 ring-background select-none",
