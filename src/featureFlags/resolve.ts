 ...
 * highest first:
 *   1. **local override** — dev/Labs escape hatch, normally wins;
 ...
 * falls through to its catalog default. Sensitive derived-data features may
 * treat an explicit trusted remote `false` as a hard veto over a local override.
 */
