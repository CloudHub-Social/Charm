...
cross-process source of truth. Settings changes that disable Sentry apply to the
already-running frontend immediately and to Rust crash monitoring on restart.
