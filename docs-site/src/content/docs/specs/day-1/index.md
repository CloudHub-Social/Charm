...
| 11 | [Push notifications](/specs/day-1/spec-11--push-notifications/) | **Follow-up** | Desktop and Android foundations shipped in [#44](https://github.com/CloudHub-Social/Charm/pull/44); iOS APNs registration shipped default-off in [#483](https://github.com/CloudHub-Social/Charm/pull/483). Killed-app delivery, extension work, and physical-device evidence remain; live APNs delivery is externally gated but does not block a Personal Team build |
...
| 22 | [Feedback categorization and GitHub label mapping](/specs/day-1/spec-22--user-feedback-categorization-and-github-label-mapping/) | **Shipped** | App category/tag shipped in [#165](https://github.com/CloudHub-Social/Charm/pull/165); Sentry-org label mapping confirmed end-to-end 2026-07-18 |
...
| 31 | [Room upgrades](/specs/day-1/spec-31--room-upgrades/) | **Shipped** | Feature-flagged admin upgrade flow and tombstoned-room guidance |
...
| 33 | [Space nesting and reorganization](/specs/day-1/spec-33--space-nesting-and-hierarchy-reorganization/) | **Shipped** | APIs and UX merged in [#321](https://github.com/CloudHub-Social/Charm/pull/321), [#333](https://github.com/CloudHub-Social/Charm/pull/333), [#334](https://github.com/CloudHub-Social/Charm/pull/334), and [#335](https://github.com/CloudHub-Social/Charm/pull/335); the real-Synapse suite verifies create-under, reparent, cycle rejection, un-nest, and resync |
...
| 36 | [User profile cards](/specs/day-1/spec-36--user-profile-cards/) | **Shipped** | Profile data/card UI merged in [#323](https://github.com/CloudHub-Social/Charm/pull/323) and [#329](https://github.com/CloudHub-Social/Charm/pull/329); member entry, identity utilities, DM/block/moderation actions, guarded request cancellation, and room-profile writes close with a two-client Synapse proof |
...
| 41 | [Voice message recording](/specs/day-1/spec-41--voice-message-recording/) | **Follow-up** | Default-off recording, preview, send, and cleanup shipped in [#496](https://github.com/CloudHub-Social/Charm/pull/496); waveform history and physical-device/cross-client verification remain |
...
| 43 | [Composer parity](/specs/day-1/spec-43--composer-parity/) | **Follow-up** | Default-off formatting, guarded editing, and the first command slices shipped in [#495](https://github.com/CloudHub-Social/Charm/pull/495); remaining commands and physical-device verification remain |
| 44 | [Crypto backup setup and key import/export](/specs/day-1/spec-44--crypto-key-backup-setup-and-key-import-export/) | **In progress** | Restore and encrypted room-key files exist; first-time backup setup remains under review in [#485](https://github.com/CloudHub-Social/Charm/pull/485) and is not release-ready while recovery findings remain unresolved |
| 45 | [Registration and password reset](/specs/day-1/spec-45--registration-and-password-reset-flows/) | **In progress** | Desktop and companion registration UIA, bounded password recovery/resend, flow discovery, advertised token login, and server-owned browser provider SSO are implemented; real-provider verification and same-device soft-logout recovery [#498](https://github.com/CloudHub-Social/Charm/issues/498) remain |
...
| 53 | [Avatars and presence visuals](/specs/day-1/spec-53--avatars-and-presence-visuals/) | **Shipped** | [#457](https://github.com/CloudHub-Social/Charm/pull/457); default-off composite group-DM avatars, aggregate presence rings/dots, real member-list avatars and presence, and busy-state visuals |
