...
| 55 | [Command palette and quick switcher](/specs/day-1/spec-55--command-palette-and-quick-switcher/) | **In progress** | Navigation, account-scoped recents, keyboard behavior, and Spec 28 boundary decision-ready; implementation pending |
