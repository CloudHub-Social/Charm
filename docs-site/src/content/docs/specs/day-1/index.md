...
| 29 | [Link previews](/specs/day-1/spec-29--link-previews/) | **Follow-up** | Desktop [#250](https://github.com/CloudHub-Social/Charm/pull/250) and web companion proxy merged; deterministic authenticated Synapse evidence harness added, awaiting a green CI run before closure |
