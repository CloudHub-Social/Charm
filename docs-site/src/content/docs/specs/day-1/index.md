...
| 45 | [Registration and password reset](/specs/day-1/spec-45--registration-and-password-reset-flows/) | **In progress** | Desktop registration UIA, email password recovery, provider-aware SSO, and advertised token login; web, provider icons, registration email UIA, and live verification remain |
