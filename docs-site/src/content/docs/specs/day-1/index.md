...
| 40 | [Presence and receipt privacy](/specs/day-1/spec-40--presence-and-receipt-privacy-controls/) | **Shipped** | Hide read receipts/typing, appear offline, auto-idle, expandable seen-by list, and presence status/last-active rendering, behind the `presence_receipt_privacy_controls` flag |
