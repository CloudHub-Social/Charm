...
| 63 | [Sidebar and space management](/specs/day-1/spec-63--sidebar-and-space-management-pin-reorder-context-menu-add-existing/) | **Shipped** | Pin/unpin, cross-device-synced reorder, Leave, Remove, Set/Unset Suggested, Add Existing, and power-level gating on the new actions all implemented; `Settings` menu item deferred to Spec 33's not-yet-built space-settings surface |
