  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        // 2026-07-06, after Spec 01's timeline/room identity + presence-dot
        // work: lines 61.87 / statements 60.57 / functions 55.67 /
        // branches 61.36), so any regression fails CI. When you add tests and
