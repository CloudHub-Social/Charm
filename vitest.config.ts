  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        // 2026-07-05, after rebasing Spec 14 — matrix-sdk-ui Timeline adoption —
        // onto Spec 06's room-list org work: lines 57.12 / statements 56.12 /
        // functions 49.4 / branches 61.95), so any regression fails CI. When you
